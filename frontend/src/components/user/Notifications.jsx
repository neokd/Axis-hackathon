    ...
    return (
        <>
            {notificationVisible && message && (
                <div className={`fixed top-12 right-0 p-4 mt-8 mr-8 z-50 ${bgColorClass} dark:text-white rounded-md shadow-md`}>
                    <p className='dark:text-white'>{message}</p>
                    <button className="absolute top-2 right-2 dark:text-white hover:text-gray-300" onClick={handleClose}>
