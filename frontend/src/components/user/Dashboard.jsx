...
function Dashboard() {
  ...
  useEffect(() => {
    setFilteredJobData(jdData); // Set the initial filtered data to jobData
  }, [jdData]);
    ...
    <div className="flex ">
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="text-xl bg-white/90 dark:bg-neutral-900 duration-300 min-h-screen  font-semibold p-4">
          ...
          <h2 className="text-2xl dark:text-white mx-8 mt-4 font-semibold">
            Welcome {data?.name}
          </h2>
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 px-8 mt-12">
            ...
            <div className="bg-zinc-100 shadow-lg hover:shadow-sky-600 duration-300 dark:bg-neutral-800 rounded-xl p-4 flex flex-row justify-between">
              <div className="">
                ...
                <h1 className="text-3xl font-semibold dark:text-white">{1}</h1>
              </div>
              <div>
          ...
          <div className="mt-12 shadow-lg bg-zinc-100 dark:bg-neutral-800 rounded-lg mx-8 py-1 w-fit">
            <h1 className="text-3xl dark:text-white/40 mx-8 mt-4 font-semibold">
              Job Suggestion
            </h1>
            <p className="text-xl text-neutral-800  dark:text-white/75 mx-8 my-4 font-semibold">
              Your Resume matches{" "}
              <span className="font-bold dark:text-white ">{domain}</span> Role.
            </p>
          </div>
